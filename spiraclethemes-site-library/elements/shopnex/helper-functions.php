...
final class Shopnex_Elementor_Extension {
    ...
    public function init_widgets() {
        ...
        require_once SPIR_SITE_LIBRARY_PATH  . '/elements/shopnex/widgets.php';
        $sslb_add_widgets = new Shopnex_Add_Widgets();
    ...
    public function admin_notice_missing_main_plugin() {
        ...
        $message = sprintf(
            ...
            '<strong>' . esc_html__( 'Shopnex Elements' ) . '</strong>', 
    ...
    public function admin_notice_minimum_elementor_version() {
        ...
        $message = sprintf(
            ...
            '<strong>' . esc_html__( 'Shopnex Elements', 'spiraclethemes-site-library' ) . '</strong>',
            esc_html__( 'inside the Elementor page builder', 'spiraclethemes-site-library' ) . '</strong>',
            '<strong>' . esc_html__( 'Elementor', 'spiraclethemes-site-library' ) . '</strong>',
    ...
    public function admin_notice_minimum_php_version() {
        ...
        $message = sprintf(
            ...
            '<strong>' . esc_html__( 'Shopnex Elementor Addons', 'spiraclethemes-site-library' ) . '</strong>',
...
Shopnex_Elementor_Extension::instance();
