...
final class Shopbar_Elementor_Extension {
    ...
    public function init_widgets() {
        ...
        require_once SPIR_SITE_LIBRARY_PATH  . '/elements/shopbar/widgets.php';
        $sslb_add_widgets = new Shopbar_Add_Widgets();
    ...
    public function admin_notice_missing_main_plugin() {
        ...
        $message = sprintf(
            ...
            '<strong>' . esc_html__( 'Shopbar Elements', 'spiraclethemes-site-library' ) . '</strong>',
...
Shopbar_Elementor_Extension::instance();
