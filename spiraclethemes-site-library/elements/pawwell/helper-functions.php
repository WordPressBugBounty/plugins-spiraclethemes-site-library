...
final class Pawwell_Elementor_Extension {
    ...
    public function init_widgets() {
        ...
        require_once SPIR_SITE_LIBRARY_PATH  . '/elements/pawwell/widgets.php';
        $sslb_add_widgets = new Pawwell_Add_Widgets();
    ...
    public function admin_notice_missing_main_plugin() {
        ...
        $message = sprintf(
            ...
            '<strong>' . esc_html__( 'Pawwell Elements', 'spiraclethemes-site-library' ) . '</strong>', 
    ...
    public function admin_notice_minimum_php_version() {
        ...
        $message = sprintf(
            ...
            '<strong>' . esc_html__( 'Pawwell Elementor Addons', 'spiraclethemes-site-library' ) . '</strong>',
...
Pawwell_Elementor_Extension::instance();
