...
final class Blogson_Elementor_Extension { // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedClassFound
    ...
    public function init_widgets() {
        ...
        require_once SPIR_SITE_LIBRARY_PATH  . '/elements/blogson/widgets.php';
        $sslb_add_widgets=new Blogson_Add_Widgets();
    ...
    public function admin_notice_minimum_php_version() {
        ...
        $message = sprintf(
            ...
            '<strong>' . esc_html__( 'Blogson Elementor Addons', 'spiraclethemes-site-library' ) . '</strong>',
...
Blogson_Elementor_Extension::instance();